...
- **00:30** - News: CNCF Technology Radar & 15.6M Cloud Native Developers
- **02:00** - Graviton5: 192 Cores, 25% Faster
- **05:00** - Customer Results: SAP, Atlassian, Honeycomb
- **06:30** - Trainium3 UltraServers: 50% Cost Reduction
- **09:00** - Lambda Durable Functions: Workflows Up to 1 Year
- **11:30** - Database Savings Plans: Up to 35% Off
- **12:30** - Werner Vogels: The Renaissance Developer
- **14:00** - Verification Debt & Code Reviews
- **15:00** - Key Takeaways
...
- **[CNCF Q4 2025 Technology Radar](https://www.cncf.io/announcements/2025/11/11/cncf-and-slashdata-report-finds-leading-ai-tools-gaining-adoption-in-cloud-native-ecosystems/)**: NVIDIA Triton, MCP, Agent2Agent (94% recommendation) lead AI tool adoption in cloud native
- **[Cloud Native Ecosystem Hits 15.6 Million Developers](https://www.cncf.io/announcements/2025/11/11/cncf-and-slashdata-survey-finds-cloud-native-ecosystem-surges-to-15-6m-developers/)**: 77% of backend devs using cloud native, 41% of AI/ML devs identify as cloud native
